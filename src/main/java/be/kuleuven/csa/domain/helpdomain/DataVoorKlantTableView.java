...
public class DataVoorKlantTableView {
    ...
    public DataVoorKlantTableView(int pakket_id, String pakket_naam, String auteur_naam, int verkoopt_prijs, int pakket_aantalVolwassenen, int pakket_aantalKinderen) {
